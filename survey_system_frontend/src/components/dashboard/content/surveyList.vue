<template>
  <div>
    ...
    <el-main style="height: 725px; padding-bottom: 0">
      <!--        table container-->
      <el-table :data="surveyList" :stripe="true" :border="true">
        <el-table-column prop="title" label="title" width="600" resizable>
        </el-table-column>
        <el-table-column prop="author" label="author" width="140" resizable>
        </el-table-column>
        ...
        <el-table-column label="operation" resizable>
          <template slot-scope="scope">
            ...
            <el-button
              type="danger"
              icon="el-icon-delete"
              @click="deleteSurvey(scope.row.id)"
              size="small"
            >
              delete
            </el-button>
...
export default {
  ...
  methods: {
    ...
    filtrateSurveyList() {
      this.$axios.get("/survey/filtrateSurveyList", {
        params: {
          title: this.title,
          author: this.author,
          page: this.curPage,
    ...
    getSurveyList() {
      this.$axios.get("/survey/getSurveyListByPage", {
        params: {
          page: this.curPage,
          pageSize: this.pageSize
        }
    ...
    deleteSurvey(id) {
      ...
      this.$confirm('Are you sure to delete this survey', '', {
        ...
        center: true
          ...
          this.$axios.delete("/survey/deleteSurveyById", {
            params: {
              id: id
            }
          }).then(data => {
